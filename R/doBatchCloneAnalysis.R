...
#' @param colourList a named list mapping a desired colour to each label in the \code{colourColumn} column in \code{inputDF}.
                                  ...
                                  useTempDir = TRUE)
{
  ...
  for( iClone in 1:length( vecCloneIDs ) )
  {
    ...
    cloneLineage( input = curClone,
                  ...
                  colourSpecification = list( colours = colourList,
